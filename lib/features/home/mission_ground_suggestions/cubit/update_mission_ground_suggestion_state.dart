...
@freezed
class UpdateMissionGroundSuggestionState
    with _$UpdateMissionGroundSuggestionState {
  ...
  const factory UpdateMissionGroundSuggestionState.error(String message) =
      _Error;
}
