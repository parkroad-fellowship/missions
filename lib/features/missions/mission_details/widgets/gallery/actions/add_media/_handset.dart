...
class _AddMediaViewHandsetState extends State<AddMediaViewHandset> {
  ...
  PRFMediaType _selectedMediaType = PRFMediaType.photos;
  ...
  Widget _buildEmptyState(BuildContext context, ThemeData theme) {
    final mediaTypeText = _selectedMediaType == PRFMediaType.photos
        ? 'photos'
        : _selectedMediaType == PRFMediaType.videos
        ? 'videos'
        : 'media';

    final emptyIcon = _selectedMediaType == PRFMediaType.photos
  ...
  void _selectMedia(
    ...
    PRFMediaType requestType;
    PRFMediaModel model;

    switch (_selectedMediaType) {
      case PRFMediaType.photos:
        requestType = PRFMediaType.photos;
        model = PRFMediaModel.missionPhotos;
      case PRFMediaType.videos:
        requestType = PRFMediaType.videos;
