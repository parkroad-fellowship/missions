...
class FAQPageTablet extends StatefulWidget {
  const FAQPageTablet({super.key});

  @override
  State<FAQPageTablet> createState() => _FAQPageTabletState();
}

class _FAQPageTabletState extends State<FAQPageTablet> {
