...
class EnquiryRepliesPageTablet extends StatefulWidget {
  const EnquiryRepliesPageTablet({required this.enquiry, super.key});

  final PRFLocalStudentEnquiry enquiry;

  @override
  State<EnquiryRepliesPageTablet> createState() =>
      _EnquiryRepliesPageTabletState();
}

class _EnquiryRepliesPageTabletState extends State<EnquiryRepliesPageTablet> {
