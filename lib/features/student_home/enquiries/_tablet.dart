...
class LearnerEnquiriesPageTablet extends StatefulWidget {
  const LearnerEnquiriesPageTablet({super.key});

  @override
  State<LearnerEnquiriesPageTablet> createState() =>
      _LearnerEnquiriesPageTabletState();
}

class _LearnerEnquiriesPageTabletState
    extends State<LearnerEnquiriesPageTablet> {
