...
import 'package:app/services/local_storage/hive/payment_hive_service.dart';
...
class DataHiveService extends BaseHiveService {
  ...
  late final PaymentHiveService _payments;
  ...
  PaymentHiveService get payments => _payments;
